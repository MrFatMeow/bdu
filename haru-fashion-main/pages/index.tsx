  ...
  return (
    <>
      ...
      <main id="main-content" className="-mt-20">
        ...
        <section className="app-max-width w-full h-full flex flex-col justify-center mt-16">
        ...
        {/* ===== Testimonial Section ===== */}
        <section className="w-full hidden h-full py-16 md:flex flex-col items-center">
          <NewArrivals />
        </section>

        {/* ===== Featured Products Section ===== */}
        <section className="app-max-width app-x-padding  flex flex-col">
